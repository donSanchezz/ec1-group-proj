<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="EBillPayment.Login" %>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <asp:Label runat="server" AssociatedControlID="Email" class="col-md-2 control-label text-light">Email</asp:Label>
                                    <div class="col-md">
                                ...
                                <div class="form-group">
                                    <asp:Label runat="server" AssociatedControlID="Password" class="col-md-2 control-label text-light">Password</asp:Label>
                                    <div class="col-md">
                                ...
                                <div class="form-group">
                                    <div class="col-md-offset-2 col-md">
                                        <div class="checkbox">
                                            ...
                                            <asp:Label runat="server" class="text-light" AssociatedControlID="RememberMe">Remember me?</asp:Label>
                                        </div>
                                    </div>
                                </div>
